...
// Déclarer une variable $categories qui contient une collections d'objet jQuery relative aux balises <li>

/*** Etape 2 ***/
// Appliquer un écouteur d'événement sur l'input "searchCategory" (le champs de recherche) qui déclenchera une fonction lorsqu'on écrira dedans. La fonction qu'on passera en paramètre de la méthode keyup sera anonyme car nous n'auront pas besoin de la réutiliser ailleurs.
